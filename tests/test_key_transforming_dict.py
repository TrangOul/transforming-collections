...
class KeyTransformingDictPerformanceTestMixin:
	...
	def test_init_same_class_no_transforms(self):
		source_dict = self.test_class({self.KEY_UNTRANSFORMED_1: 'untransformed'})
	...
	def test_or_no_transform_this_class(self):
		d1 = self.test_class({self.KEY_TRANSFORMED_1: 1, self.KEY_TRANSFORMED_2: 2})
		d2 = self.test_class({self.KEY_TRANSFORMED_1: 3, self.KEY_TRANSFORMED_3: 4})
	...
	def test_eq_no_transforms_this_class(self):
		d1 = self.test_class({self.KEY_TRANSFORMED_1: 1})
		d2 = self.test_class({self.KEY_TRANSFORMED_1: 1})
